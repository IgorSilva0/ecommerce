			...
			<div className="rounded-lg bg-white p-6 shadow-md">
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-lg">
						...
						If you are not completely satisfied, you may return items within 30 days of the purchase
						date for a full refund or exchange. The returned product must be in its original
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-lg">
						...
						your personal information when you visit our website and make a purchase.
					</p>
					<p className="mb-4 text-lg">
						We collect personal information such as your name, email address, shipping address, and
						payment information to process your orders and provide a seamless service. We do not
						share your information with third parties, except as necessary to fulfill your order or
						as required by law.
					</p>
					<p className="mb-4 text-lg">
						We implement industry-standard security measures to protect your information. While we
						strive to secure your data, no method of electronic storage or transmission is entirely
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-lg">
						We offer prompt and reliable shipping to ensure you receive your orders quickly. Orders
						are processed within 1-2 business days and shipped via [Shipping Carrier]. You will
						receive a tracking number once your order is on its way.
					</p>
					<p className="mb-4 text-lg">
						Delivery times vary by location. For estimated delivery times, please refer to our
						shipping information page. For any questions regarding your shipment, please contact our
				...
				<section className="mb-8">
					...
					<p className="mb-4 text-lg">
						If you have any questions or concerns regarding our policies, please don&apos;t hesitate
						to contact us. Our customer service team is dedicated to assisting you and ensuring a
