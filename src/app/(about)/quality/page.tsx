			...
			<div className="text-center">
				...
				<div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-700">
					...
					<p className="mb-4 text-lg">
						...
						our stringent standards. From the materials used to the final product, we pay attention
						to every detail to ensure you receive only the best.
					</p>
					...
					<p className="mb-4 text-lg">
						If you have any questions or concerns about our quality guarantee, please do not
						hesitate to contact us. Our customer service team is here to assist you and ensure you
